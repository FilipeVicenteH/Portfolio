...
const projects = [
  ...
  },
  {
    ...
    image: '/projects/painelunico.jpg',
        ...
        <div className="space-y-12">
          {projects.map((proj, i) => (
            ...
            >
              ...
              <div className="bg-navy-darker/80 px-4 py-3 border-b border-navy-lighter/30 flex items-center justify-between">
              ...
              {/* Grid: Visual Showcase Image + Project Details */}
              <div className="grid lg:grid-cols-12 gap-0">
                {/* Visual Image Preview Frame */}
                <div className="lg:col-span-5 relative overflow-hidden bg-navy-darker flex items-center justify-center group">
                  <img
                    src={proj.image}
                    alt={proj.title}
                    className="w-full h-full object-cover object-top min-h-[220px] max-h-[280px] lg:max-h-full group-hover:scale-105 transition-transform duration-500 opacity-90 group-hover:opacity-100"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-navy-light via-transparent to-transparent lg:bg-gradient-to-r lg:from-transparent lg:to-navy-light pointer-events-none"></div>
                </div>
